                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <p class="category">
                                <span>Commandes de validées et non validées</span>
                            </p>
                        ...
                        <div class="content table-responsive table-full-width">
                            <table class="table table-hover table-striped">
                                ...
                                @forelse ($commandes as $commande)
                                    <?php $i++?>
                                    <tr @if($commande['etat_command'] == 1) style="background: rgba(223,43,55,0.65)" @endif>
                                        <td>{{$i}}</td>
                                        ...
                                        <td> @if($commande['etat_command'] == 1) <span class="badge" style="background: #4cae4c">validé</span> @else <span class="badge bg-info" style="background: #ae3e32">En cours</span> @endif</td>
                                        <td>{{$commande['mode_payement']['titre_modpay']}}</td>
                                        <td><a href="{{url('distributeurs/'.$distributeur['id_dist'])}}#addModal" data-total="{{$commande['totalttc_command']}}" data-id="{{$commande['id_command']}}" data-numero="{{$commande['numero_command']}}" class="btn btn-primary modify_item" data-toggle="modal">@if($commande['etat_command'] == 1) Détails @else Valider @endif</a></td>
                                    </tr>
                                @empty
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info" id="validBtn">Valider</button>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#validBtn').on('click', function (e) {
                $.ajax({
                    url: "{{url('commandes')}}" + '/' + idCommande + '/valid',
                    type: 'get',
                    beforeSend: function () {
                        $("#message").html("");
                    },
