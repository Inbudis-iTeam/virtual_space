...
@section('title') Types de migration @stop
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Types de migration</h4>
                        <p class="category">
                    ...
                    <div class="content table-responsive table-full-width">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <?php $i = 0?>
                                @forelse ($typesMigrations as $typeMigration)
                                <?php $i++?>
                                <tr>
                                    <td>{{$i}}</td>
                                    <td>{{$typeMigration['titre_typmig']}}</td>
                                    <td class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="{{url('type_migration/modify') ."/". $typeMigration['id_typmig']}}#addModal" class="modify_item" data-toggle="modal" data-titre="{{$typeMigration['titre_typmig']}}">Modifier</a></li>
                                            <li>
                                                <a href="{{url('type_migration/delete')."/". $typeMigration['id_typmig']}}" class="delete_item">Supprimer</a>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/type_migration/add')}}" id="addForm">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.add_item').on('click', function (e) {
                ...
                $("#message").html('');
                $('#addForm').attr("action", "{{url('type_migration/add')}}");
                $("#nameItem").val('');
            });
